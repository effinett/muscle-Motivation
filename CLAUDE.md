...
- **Branch protection** — the `verify` check is not yet required on `main` (roadmap §2.2; the exact
  manual step is in `docs/ROADMAP-HISTORY.md`).
